<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
    <thead>
        <tr>
            ...
            <th style="width: 5%;"> Project Discipline </th>
        ...
        @if(count($result_datas)>0)
            ...
            @foreach($result_datas as $result_data)
                @php 
                    ...
                    $total_sum_col[6]+=$result_data->sum;
                    $total_sum_col[7]+=$result_data->rates;
                    $total_sum_col[8]+=$result_data->sum * $result_data->rates;
                ...
                <tr>
                    ...
                    <td class="center">{{ $result_data->fullname }}</td>
                    ...
                    <td style="display:none;"><input type='hidden' name='timesheet_id[]' value='{{ $result_data->id }}' /></td>
                </tr>
            ...
            <tr>
                ...
                <td></td>
                <td class="center" id="total_total">{{ $total_sum_col[6] }}</td>
                <td class="center" id="total_rates">{{ $total_sum_col[7] }}</td>
                <td class="center" id="total_AED">{{ $total_sum_col[8] }}</td>
