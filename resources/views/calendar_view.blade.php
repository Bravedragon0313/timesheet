                        ...
                        <div class="portlet light calendar bordered">
                            <div class="portlet-title ">
                                <div class="caption">
                                    ...
                                    &nbsp &nbsp &nbsp
                                    <a href="{!! url('/calendar_create'); !!}" class="btn btn-success uppercase"> Add Calendar </a>
                                    &nbsp &nbsp &nbsp
                                    @if(count($tasks)>0)
                                    <a href="{!! url('/calendar_delete'); !!}" class="btn btn-danger uppercase"> delete Calendar </a>
                                    @endif
                                </div>
                            </div>
                            @if(count($tasks)>0)
                            <div class="alert alert-info uppercase" style="text-align: center;">please click any task for edit </div>
                            @endif
                            <br>
                            <br>
                            <div class="portlet-body">
        ...
        $('#calendar_view').fullCalendar({
            ...
            events : [
                @foreach($tasks as $task)
                {
                    ...
                    @endif
                    url : base_url + '/calendar_edit/{{ $task->id }}'
                },
                @endforeach
            ]
        });
