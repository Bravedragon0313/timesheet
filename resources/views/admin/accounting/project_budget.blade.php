...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <form method="post" action="{{ url('admin/accounting/project_budget_store') }}">{{ csrf_field() }}
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select id="project_sel" name="project_id" class="form-control input-sm select2-multiple">
                                        <option></option>
                        ...
                        <div id="projectbudgetContent" data-url={{route('projectbudget.content')}}></div>
                    </div>
                </div>
