...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <form method="post" action="{{ url('admin/accounting/staff_rates_store') }}">{{ csrf_field() }}
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select id="employee_sel" name="employee_id" class="form-control input-sm select2-multiple">
                                        <option></option>
                        ...
                        <div id="staffratesContent" data-url={{route('staffrates.content')}}></div>
                    </div>
                </div>
