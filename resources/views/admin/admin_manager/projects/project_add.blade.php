        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered" id="form_wizard_1">
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form class="form-horizontal" method="post" action="{{ url('admin/projects/create') }}" name="add_project" id="add_project">{{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="project_totalhrs" id="project_totalhrs" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                                <label class="control-label col-md-3">Project Rate</label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="project_rate" id="project_rate" />
                                </div>
                            </div>
                            <div class="form-group has-success">
                            ...
                            <div class="form-group has-success">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="employee_num" id="employee_num" />
                                </div>
                            </div>
                            <div class="form-group has-success">
