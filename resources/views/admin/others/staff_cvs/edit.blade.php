...
<div class="page-content-wrapper">
    ...
    <div class="page-content">     
      ...
      <div class="container">
        <form id="file-upload-form" class="form-horizontal" action="{{url('admin/others/staff_cvs/update/'.$staffDetails->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          @csrf
          <div class="form-body">
            <h3 class="form-section">Edit Staff CVs</h3>
            <div class="form-group has-success">
                <label class="control-label col-md-3">Staff Name</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="staff_name" value="{{ $staffDetails->staff_name }}" required/>
                </div>
            </div>
            <div class="form-group has-success">
