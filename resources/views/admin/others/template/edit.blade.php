...
<div class="page-content-wrapper">
    ...
    <div class="page-content">     
      ...
      <div class="container">
        <form id="file-upload-form" class="form-horizontal" action="{{url('admin/others/templates/update/'.$staffDetails->id)}}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
          @csrf
          <div class="form-body">
            <h3 class="form-section">Edit Template</h3>
            <div class="form-group has-success">
                <label class="control-label col-md-3">Template Name</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" name="template_name" value="{{ $staffDetails->template_name }}" required/>
                </div>
            </div>
            <div class="form-group has-success">
