...
<html lang="en">
    ...
    <!-- END HEAD -->
        ...
        <link href="{{ asset('css/clock_modern.css') }}" rel="stylesheet">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <!-- <script src="{{ asset('assets/global/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js') }}" type="text/javascript"></script> -->
        ...
        <script src="{{ asset('js/calendarview.js') }}"></script>
